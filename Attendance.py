...
class Attendance:
    ...
    # ================= FORM FRAME =================
        ...
        form_frame.place(x=0, y=0, width=700, height=320)

        # Department
        Label(form_frame, text="Department:", font=("Segoe UI", 12, "bold"), bg="white").grid(row=0, column=0, padx=10, pady=8, sticky=W)
        Entry(form_frame, textvariable=self.var_atten_dep, font=("Segoe UI", 12), bg="lightyellow").grid(row=0, column=1, padx=10, pady=8)

        # Attendance ID
        Label(form_frame, text="Attendance ID:", font=("Segoe UI", 12, "bold"), bg="white").grid(row=1, column=0, padx=10, pady=8, sticky=W)
        Entry(form_frame, textvariable=self.var_atten_id, font=("Segoe UI", 12), bg="lightyellow").grid(row=1, column=1, padx=10, pady=8)

        # Student ID
        Label(form_frame, text="Student ID:", font=("Segoe UI", 12, "bold"), bg="white").grid(row=2, column=0, padx=10, pady=8, sticky=W)
        Entry(form_frame, textvariable=self.var_atten_roll, font=("Segoe UI", 12), bg="lightyellow").grid(row=2, column=1, padx=10, pady=8)

        # Student Name
        Label(form_frame, text="Student Name:", font=("Segoe UI", 12, "bold"), bg="white").grid(row=3, column=0, padx=10, pady=8, sticky=W)
        Entry(form_frame, textvariable=self.var_atten_name, font=("Segoe UI", 12), bg="lightyellow").grid(row=3, column=1, padx=10, pady=8)

        # Attendance Status
        Label(form_frame, text="Attendance Status:", font=("Segoe UI", 12, "bold"), bg="white").grid(row=4, column=0, padx=10, pady=8, sticky=W)
        ...
        status_combo.grid(row=4, column=1, padx=10, pady=8)
